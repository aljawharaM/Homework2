...
```{r}
nobel_living_science<-nobel_living_science%>%mutate(born_country_us=if_else(born_count=="USA","USA","other"))
nobel_living_science %>% filter(born_country_us == "USA") %>% count(born_country_us) 
```
...
Yes, because at buzzfeed we analyze the data to look for more data and get information from that, so we go deeper into it and do a lot of exercises to understand the data. 
